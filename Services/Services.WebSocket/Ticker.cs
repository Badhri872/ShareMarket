...
namespace Services.WebSocket
{
    public class Ticker
    {
        ...
        public Ticker(string userId, string accessToken, string socketUrl = null, bool reconnect = false, int reconnectInterval = 5, int reconnectTries = 50, bool debug = false)
        {
            ...
            /*_webSocketThread = new Thread(onTimerTick);*/
        ...
        {
            if (_debug) Utilities.LogMessage("On Data event");
            ...
            if (MessageType == "Text")
            {
                ...
                if (_debug) Utilities.LogMessage("WebSocket Message: " + message);
                ...
                if (data["t"] == "ck")
                {
                    ...
                    if (_debug)
                        Utilities.LogMessage("Connection acknowledgement received. Websocket connected.");
                }
                ...
                {
                    if (_debug)
                        Utilities.LogMessage($"Unknown feed type: {data["t"]}");
                }
            }
        ...
        private void _onTimerTick(object sender, System.Timers.ElapsedEventArgs e)
        {
            ...
            if (_debug) Utilities.LogMessage(_timerTick.ToString());
        }
        ...
        private void Reconnect()
        {
            ...
            else
            {
                ...
                if (_debug) Utilities.LogMessage("New interval " + _timerTick);
                _timer.Start();
            }
        }
        ...
        public void Subscribe(string mode, SubscriptionToken[] tokens)
        {
            ...
            if (_debug) Utilities.LogMessage(requestJson.Length.ToString());
        ...
        {
            if (_debug) Utilities.LogMessage("Resubscribing");
